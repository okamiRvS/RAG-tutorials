...
MODEL_EMBEDDINGS = "jeffh/intfloat-multilingual-e5-large-instruct:f16"
...
# Get MODEL_EMBEDDINGS vector dimension
MODEL_EMBEDDINGS_VECTOR_DIMENSION = len(
...
def extract_structured_data(qdrant_client, collection_name):
    ...
    create_collection(
        qdrant_client,
        collection_name,
        MODEL_EMBEDDINGS_VECTOR_DIMENSION,
    )
